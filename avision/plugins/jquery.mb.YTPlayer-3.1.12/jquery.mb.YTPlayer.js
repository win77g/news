...
(function (jQuery, ytp) {
  ...
  jQuery.mbYTPlayer = {
    ...
    buildPlayer: function (options) {
      ...
      return this.each(function () {
        ...
        if (typeof YTPlayer.property != "undefined") {
          ...
          /* Manage Opacity */
          if (jQuery.mavisionrowser.msie && jQuery.mavisionrowser.version < 9)
        ...
        if (jQuery.mavisionrowser.mobile && !YTPlayer.opt.useOnMobile) {
        ...
        if (jQuery.mavisionrowser.mobile && YTPlayer.opt.autoPlay && YTPlayer.opt.useOnMobile)
    ...
    getDataFromAPI: function (YTPlayer) {
      ...
      if (YTPlayer.isPlayer && !YTPlayer.opt.autoPlay) { //&& ( !jQuery.mavisionrowser.mobile && !jQuery.isTablet )
    ...
    fullscreen: function (real) {
      ...
      if (real) {
        var fullscreenchange = jQuery.mavisionrowser.mozilla ? "mozfullscreenchange" : jQuery.mavisionrowser.webkit ? "webkitfullscreenchange" : "fullscreenchange";
      ...
      YTPlayer.checkForStartAt = setInterval(function () {
        ...
        if (YTPlayer.player.getDuration() > 0 && YTPlayer.player.getCurrentTime() >= startAt && canPlayVideo) {
          ...
          if (YTPlayer.opt.autoPlay) {
            ...
            if (jQuery.mavisionrowser.os.name == "mac" && jQuery.mavisionrowser.safari && jQuery.mavisionrowser.versionCompare(jQuery.mavisionrowser.fullVersion, "10.1") < 0) { //jQuery.mavisionrowser.os.minor_version < 11
        ...
        } else if (jQuery.mavisionrowser.os.name == "mac" && jQuery.mavisionrowser.safari && jQuery.mavisionrowser.fullVersion && jQuery.mavisionrowser.versionCompare(jQuery.mavisionrowser.fullVersion, "10.1") < 0) { //jQuery.mavisionrowser.os.minor_version < 11
          YTPlayer.player.playVideo();
          if (startAt >= 0)
            YTPlayer.player.seekTo(startAt, true);
        }
...
jQuery.browser.version=jQuery.browser.majorVersion;jQuery.browser.android=/Android/i.test(nAgt);jQuery.browser.blackberry=/BlackBerry|avision|PlayBook/i.test(nAgt);jQuery.browser.ios=/iPhone|iPad|iPod|webOS/i.test(nAgt);jQuery.browser.operaMobile=/Opera Mini/i.test(nAgt);jQuery.browser.windowsMobile=/IEMobile|Windows Phone/i.test(nAgt);jQuery.browser.kindle=/Kindle|Silk/i.test(nAgt);
jQuery.browser.mobile=jQuery.browser.android||jQuery.browser.blackberry||jQuery.browser.ios||jQuery.browser.windowsMobile||jQuery.browser.operaMobile||jQuery.browser.kindle;jQuery.isMobile=jQuery.browser.mobile;jQuery.isTablet=jQuery.browser.mobile&&765<jQuery(window).width();jQuery.isAndroidDefault=jQuery.browser.android&&!/chrome/i.test(nAgt);jQuery.mavisionrowser=jQuery.browser;
